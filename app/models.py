...
class User(db.Model):
	...
	#brokered_loads = db.relationship('Load', backref='broker', foreign_keys='load.broker_id')
	#assigned_loads = db.relationship('Load', backref='carrier', foreign_keys='load.carrier_id')
